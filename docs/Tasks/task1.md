...
- **Fecha:** 19/02/2026
- **Descripción breve:** Clasificación de brazos robóticos y manipuladores industriales basados en sus tipos de articulaciones (Revolutas y Prismáticas) y su espacio de trabajo.

!!! tip "Consejo"
    La nomenclatura de las articulaciones (como **PPP**, **RRP**, **RRR**) define el tipo de movimiento desde la base hasta el efector final: **P** para Prismática (lineal) y **R** para Revoluta (rotacional).

---

## 2) Objetivos

- **General:** Identificar y clasificar los diferentes tipos de robots industriales según su morfología.
- **Específicos:**
  - Comprender las configuraciones de articulaciones (Cartesiana, Cilíndrica, Esférica, etc.).
  - Analizar el espacio de trabajo que genera cada configuración geométrica.
  - Relacionar cada morfología con su aplicación principal en la industria (ensamblaje, soldadura, impresión 3D).

---

## 3) Alcance y Exclusiones

- **Incluye:** Análisis de robots Cartesianos, SCARA, Articulados, Esféricos, Cilíndricos y Delta (Paralelos).
- **No incluye:** Robots móviles (AGVs, AMRs), drones o robótica blanda (soft robotics).
...
**Materiales**
- No materials required. (Investigación teórica y análisis morfológico).
